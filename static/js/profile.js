    ...
    <div class="profile-info">
      <div class="profile-section">
        ...
        <div class="profile-details">
          ...
          <p><strong>Current Level:</strong> <span id="level"></span></p>
        </div>
      </div>
      ...
      <div class="profile-section">
        ...
        <div class="audit-stats">
          <p><strong>Audit Ratio:</strong> <span id="auditRatio"></span></p>
          <p><strong>Total Upvotes:</strong> <span id="totalUp"></span></p>
          <p><strong>Total Downvotes:</strong> <span id="totalDown"></span></p>
        </div>
      </div>
      ...
      <div class="profile-section">
        <h3>XP Statistics</h3>
        <div class="xp-stats">
          <p><strong>Total XP:</strong> <span id="totalXp"></span></p>
        </div>
        <div id="xpGraph"></div>
      </div>
      ...
      <div class="profile-section">
        ...
        <div class="project-stats">
          <p><strong>Completed Projects:</strong> <span id="completedProjects"></span></p>
          <p><strong>Current Projects:</strong> <span id="currentProjects"></span></p>
        </div>
